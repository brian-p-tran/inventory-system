...
* [http://localhost:8080/suppliers](http://localhost:8080/suppliers)
...
| ----- | --------------------------------------------------------- |
| name  | Lebron James                                              |
| email | [lebronjames@example.com](mailto:lebronjames@example.com) |
| phone | 982-1133                                                  |
...
| action      | add                                         |
| name        | New Supplier                                |
| contactInfo | [new@supplier.com](mailto:new@supplier.com) |
...
| action      | update                                              |
| supplierId  | 2                                                   |
| contactInfo | [updated@supplier.com](mailto:updated@supplier.com) |

### Delete Supplier (keys are case-sensitive)
